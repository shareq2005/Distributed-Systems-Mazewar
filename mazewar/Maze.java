...
public abstract class Maze {
    ...
    /* Maze Information ****************************************************/
	/**
	 * Pass the output stream so that it can be called by killClient later
	 */
	 ...
	 */
	public abstract void pass_local_client_id(int client_id);
	
	/* pass client details */
	public abstract void respawn_remote_client(Client client, int x, int y);
